package com.tenyon.web.manager;
...
import com.tenyon.web.model.dto.file.UploadPictureResult;
...
//            // 计算宽高
            ...
            uploadPictureResult.setUrl(FileConstant.MINIO_HOST + "/" + minioClientConfig.getBucket() + uploadPath);
